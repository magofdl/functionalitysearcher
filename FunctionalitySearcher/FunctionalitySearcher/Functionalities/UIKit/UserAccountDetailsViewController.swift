...
/// UserAccountDetailsViewController version that uses external data from resolver
/// This demonstrates how functionalities can access data not stored in AppContext
class UserAccountDetailsViewController: IndependentFunctionalityViewController {
